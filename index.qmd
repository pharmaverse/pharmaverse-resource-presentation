...
format:
  revealjs:
    ...
    footer: "pharmaverse | Navitas Presentation"
    transition: slide
...
We'll explore the key **pharmaverse** resources that can help streamline clinical reporting.
...
## Resource 1 {.resource-tile background-color="#003087"}

::: {style="text-align:center; margin-top:2em;"}
![](assets/img/pharmaverse_logo.png){style="width:220px; filter:drop-shadow(2px 4px 16px rgba(255,255,255,0.3));"}

::: {style="color:#ffffff; font-size:1.5em; font-weight:700; margin-top:0.5em;"}
pharmaverse.org
:::

::: {style="color:#68b3e0; font-size:1.1em;"}
...
- Host here or link to Company Repos, e.g. [tfrmt](https://github.com/GSK-Biostatistics/tfrmt)
:::
...
## Resource 2 {.resource-tile background-color="#003087"}

::: {style="text-align:center; margin-top:2em;"}
![](assets/img/pharmaverse_examples.png){style="width:220px; border-radius:10px; box-shadow: 2px 4px 16px rgba(255,255,255,0.2);"}
...
- Metadata/Spec for all ADaMs (Just for demo purposes!!)
...
- Therapeutic Area analyses (Oncology, Ophtha, …)
:::
...
## Resource 3 {.resource-tile background-color="#003087"}

::: {style="text-align:center; margin-top:2em;"}
![](assets/img/pharmaverseblog_logo.png){style="width:220px; filter:drop-shadow(2px 4px 16px rgba(255,255,255,0.3));"}
...
✅ Short ✅ Personalized ✅Reproducible ✅ Introductory
:::
...
## Resource 4 {.resource-tile background-color="#003087"}

::: {style="text-align:center; margin-top:2em;"}
![](assets/img/admiral_logo.png){style="width:220px; filter:drop-shadow(2px 4px 16px rgba(255,255,255,0.3));"}
...
## Resource 5 {.resource-tile background-color="#003087"}

::: {style="text-align:center; margin-top:2em;"}
![](assets/img/pharmaversesdtm_logo.png){style="width:220px; filter:drop-shadow(2px 4px 16px rgba(255,255,255,0.3));"}
![](assets/img/pharmaverseadam_logo.png){style="width:220px; filter:drop-shadow(2px 4px 16px rgba(255,255,255,0.3));"}
...
- [Detailed Documentation](https://pharmaverse.github.io/pharmaversesdtm/reference/index.html) for each dataset
:::
...
## Let's Take a Tour! {.smaller background-color="#1a6b9f"} 
